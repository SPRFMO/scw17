...
1. Rapporteur's notes for the Day 3 discussion of CMPs were not yet available when this draft was prepared, and additional text will be added as those notes become available.
...
#| fig-cap: 'Draft candidate management procedure piecewise-linear harvest-control-rule shapes. Output = "catch"; dashed vertical lines show trigger values, dotted vertical lines show limits, and horizontal lines show minimum and target catch. Quadrant colors are used only to enhance visualization of HCR-shape differences and do not indicate stock-status concerns.'
#| echo: false
#| message: false
#| warning: false
#| fig-width: 10
