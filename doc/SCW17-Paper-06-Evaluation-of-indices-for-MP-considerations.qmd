...
For `h2_0.16`, the residual correlations are interpreted within the two-stock model structure. Pairs with strong positive residual correlations indicate indices that still tend to be high or low together after fitting the stock-specific trends; pairs closer to zero or negative values indicate more distinct residual information and may be more informative for availability trade-offs.
