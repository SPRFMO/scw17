...
#| fig-cap: !expr paste("Historical and future recruitment for the selected operating model. The future portion uses the F = 0 projection. Colored lines show", length(unique(rec_worms_dt$iter)), "sampled MCMC draws.")
#| fig-width: 12
#| fig-height: 6
